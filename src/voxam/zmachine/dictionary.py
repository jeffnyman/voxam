...
from voxam.zmachine.zscii import alphabets, encode_word, extras, zscii_to_char
...
class Dictionary:
    ...
    def lookup(self, word: str) -> int:
        ...
        target = encode_word(self._version, word, self._rows, self._extras)
