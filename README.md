...
and drawn. A Glulx story is read but not yet run: the port loads
one, holds its header to every promise it makes, lays out its
memory map and has the story name itself, which is where that era
begins.
